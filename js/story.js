    ...
    branches: {
      ...
      lake_try: {
        beats: [
          ...
          {
            passages: [
              { text: "Finally, without thinking, you say it.", class: "whisper" },
            ],
            delay: 800
          },
          {
    ...
    branches: {
      depart_resist: {
        beats: [
          {
            passages: [
              { text: '"Turn around. We don\'t have to go."', class: "spoken" },
        ...
        beats: [
          {
            passages: [
              ...
              { text: "The men start yelling at each other. Mom gets out and starts yelling at them.", class: "" },
              { text: "She stomps back to the truck and slams the door. You wait for the shifter to snap off when she yanks it into drive, but it holds.", class: "" },
            ],
            delay: 1200
          },
          {
